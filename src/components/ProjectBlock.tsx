...
export function ProjectBlock({
  ...
  return (
    <div className="relative flex flex-col break-words rounded border-2 border-solid border-text bg-background p-2 shadow-project-block hover:-translate-x-1 hover:-translate-y-1 hover:shadow-project-block-hover">
      <Link
